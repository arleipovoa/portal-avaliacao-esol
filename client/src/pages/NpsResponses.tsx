  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        ...
        <h1 className="text-2xl font-display font-semibold text-white">Respostas da Pesquisa</h1>
        <p className="text-sm text-slate-400 mt-1">Visualize as respostas individuais dos clientes.</p>
      </div>
