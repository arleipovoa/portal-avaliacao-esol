-- Insert Obra Evaluation Criteria
-- These criteria are used to evaluate the quality of installations/works
-- Execute this script after running the 0004_add_obra_tables.sql migration

-- ─── SEGURANÇA (Weight: 2.0) ───
